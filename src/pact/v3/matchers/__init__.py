"""
Matcher implementations for pact-python.
"""
...
class ConcreteMatcher(Matcher):
    ...
    def __init__(
        ...
        *,
        force_generator: Optional[boolean] = False,
        **kwargs: Optional[str | int | float | bool],
        ...
        Args:
            ...
            **kwargs (Optional[str | int | float | bool], optional):
...
type MatchType = str | int | float | bool | dict | list | tuple | None | Matcher
...
@overload
def number(value: Optional[float] = None, digits: Optional[int] = None) -> Matcher: ...
