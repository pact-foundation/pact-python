...
from examples.v2.src.consumer import User, UserConsumer
from pact.v2 import Consumer, Format, Like, Provider
...
def pact(broker: URL, pacts_path: Path) -> Generator[Pact, Any, None]:
    """
    Set up Pact.
