...
This module tests the Flask provider defined in `src/flask.py` against the mock
consumer. The mock consumer is set up by Pact and will replay the requests
...
import examples.v2.src.flask
from examples.v2.src.flask import User, app
from flask import request
from pact.v2 import Verifier  # type: ignore[import-untyped]
...
def mock_user_123_doesnt_exist() -> None:
    ...
    examples.v2.src.flask.FAKE_DB = MagicMock()
    examples.v2.src.flask.FAKE_DB.get.return_value = None
...
def mock_user_123_exists() -> None:
    ...
    """
    examples.v2.src.flask.FAKE_DB = MagicMock()
    examples.v2.src.flask.FAKE_DB.get.return_value = User(
        id=123,
        name="Verna Hampton",
...
def mock_post_request_to_create_user() -> None:
    ...
    examples.v2.src.flask.FAKE_DB = mock_db
