...
import examples.v2.src.fastapi
from examples.v2.src.fastapi import User, app
...
def mock_user_123_doesnt_exist() -> None:
    ...
    examples.v2.src.fastapi.FAKE_DB = MagicMock()
    examples.v2.src.fastapi.FAKE_DB.get.return_value = None
...
def mock_user_123_exists() -> None:
    ...
    examples.v2.src.fastapi.FAKE_DB = mock_db
